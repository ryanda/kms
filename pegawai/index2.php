	        ...
	        <nav class="green darken-4" id="top">
	            <div class="nav-wrapper container">
	                ...
	                <ul id="nav-mobile" class="right hide-on-med-and-down">
						<li><a href="index2.php"><i class="mdi-action-home left"></i>Home</a></li>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col s5 offset-s3">
						...
						<a href="index.php" class="btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Click Me!">Menu</a>
	                </div>
	            </div>
	        </div>
