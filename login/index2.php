...
header('Location:index2.php?login=Maaf password atau username anda salah!');
}
}
else {
unset($_POST['login']);
	    ...
	    <header>
	        <nav class="green lighten-2">
	            <div class="nav-wrapper container">
	                <a class="brand-logo">Form Login</a>
	            </div>
	        </nav>
	    </header>
	    <!--    end header navbar-->
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col s5 offset-s3">
	                	<form action="index2.php" method="post" name="postform">
	                		<p>Username</p>
